...
| :-: | :--- | :--- | :---: | :-: |
| **ДЗ 1** | Домашнее задание | **Describe a programming language (C++)** | [`hometask_cpp.md`](foreign-language/practices/hometask_cpp.md), [`hometask_cpp.docx`](foreign-language/practices/hometask_cpp.docx) | 🔵 Готово к сдаче |
